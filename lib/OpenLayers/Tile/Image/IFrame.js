...
OpenLayers.Tile.Image.IFrame = {
    ...
    getImage: function() {
        if (this.useIFrame === true) {
            ...
            if(gutter > 0){
                var left = gutter / this.layer.tileSize.w * 100,
                  top = gutter / this.layer.tileSize.h * 100;
    ...
    createRequestForm: function() {
        ...
        if (OpenLayers.Util.isArray(this.layer.url)) {
            form.action = OpenLayers.Util.urlAppend(OpenLayers.Layer.HTTPRequest.prototype.selectUrl(cacheId, this.layer.url), cacheId);
        } else {
